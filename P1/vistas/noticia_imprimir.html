...
<div class="contenedor-general">
    ...
    <div id="autor-fecha" class="texto-noticia">
      Jason Koebler, Jan 20 2017, 7:23pm
    </div>

    <div id="cuerpo" class="texto-noticia blanco-negro">
    <p>
      Una organización sin fines de lucro, un agitador y su abogado pro bono, lograron que la CIA subiera los contenidos completos de su base de dato de archivos desclasificados, lo que significa que ahora es posible acceder a 13 millones de documentos de la CIA, los que datan desde comienzos de la guerra fría.
  </p>


  <figure class="imagen-noticia blanco-negro">
    <img src="../imagenes/01.jpeg">
    <figcaption>Estos cuatro ordenadores eran el único lugar en que se podía acceder a CREST. Imagen: Michael Best</figcaption>
  </figure>

  <p>
      Desde el año 2000, la CIA ha mantenido la herramienta de búsqueda de archivos (o CREST, por sus siglas en inglés) en los archivos nacionales de College Park, Maryland. La base de datos de CREST contiene todos los archivos de "valor histórico" que fueron desclasificados gracias a una orden ejecutiva de Bill Clinton en 1995. Se podía acceder a ellos públicamente, pero sólo utilizando cuatro ordenadores y durante horas muy limitadas.
